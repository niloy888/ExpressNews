...
<!-- ########## START: LEFT PANEL ########## -->
<div class="sl-logo"><a href="{{route('reporter-dashboard')}}"><i class="icon ion-android-star-outline"></i> Express News</a></div>
<div class="sl-sideleft">
    ...
    <div class="sl-sideleft-menu">
        <a href="{{route('reporter-dashboard')}}" class="sl-menu-link">
      ...
      {{--  <a href="widgets.html" class="sl-menu-link">
        ...
        <a href="{{route('reporter-manage-post')}}" class="sl-menu-link">
            <div class="sl-menu-item">
                <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
        ...
        <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{route('reporter-add-post')}}" class="nav-link">Add Post</a></li>
            <li class="nav-item"><a href="{{route('reporter-manage-post')}}" class="nav-link">Manage Post</a></li>
        </ul>--}}
        ...
        <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{route('reporter-manage-today-news')}}" class="nav-link">All News</a></li>
            <li class="nav-item"><a href="{{route('reporter-manage-breaking-news')}}" class="nav-link">Breaking News</a></li>
        </ul>
        ...
        <nav class="nav">
            <div class="dropdown">
                <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                    ...
                    <span class="logged-name">{{ Session::get('reporter_name') }}</span>
                ...
                <div class="dropdown-menu dropdown-menu-header wd-200">
                    <ul class="list-unstyled user-profile-nav">
                        ...
                        <li>
                            ...
                            <form id="logoutForm" action="{{route('reporter-logout')}}" method="post">
                                @csrf
                            </form>
                        </li>
                    </ul>
