                ...
                <table id="datatable1" class="table-responsive table display responsive">
                    ...
                    @foreach($posts as $post)
                        <tr>
                            ...
                            <td><a href="{{route('reporter-manage-comments',['id'=>$post->id])}}">Click here</a></td>
                            <td>
                                <a href="{{route('single-article',['id'=>$post->id])}}" target="_blank"
                                   class="btn btn-sm btn-primary">View</a>
                                <a href="{{route('reporter-edit-post',['id'=>$post->id])}}"
                                ...
                                >Delete</a>
                                <form id="deleteCategoryForm{{$post->id}}" action="{{route('reporter-delete-post')}}"
                                      method="post">
                                    @csrf
