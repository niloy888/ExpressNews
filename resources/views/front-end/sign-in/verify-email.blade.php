...
<div class="d-flex align-items-center justify-content-center bg-sl-primary ht-100v">
    ...
    <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white">
        <div class="signin-logo tx-center tx-24 tx-bold tx-inverse">Express <span class="tx-info tx-normal">News</span></div>
        <div class="tx-center mg-b-60"></div>
        <h5 class="text-center text-danger">{{Session::get('message')}}</h5>


        <div class="mg-t-60 tx-center">A link sent to your email. Please click on that link to verify your email </div>
    </div><!-- login-wrapper -->
</div><!-- d-flex -->
