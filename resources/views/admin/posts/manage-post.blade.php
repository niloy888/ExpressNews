                    ...
                    <table id="datatable1" class="table-responsive table display responsive" style="width: 100%;">
                        ...
                        @foreach($posts as $post)
                            <tr>
                                ...
                                <td>{{\Carbon\Carbon::parse($post->publication_date)->format('d/m/Y')}}</td>
                                <td><a href="{{route('manage-comments',['id'=>$post->id])}}">Click here</a></td>
                                <td>
                                    ...
                                    >Delete</a>
                                    <form id="deleteCategoryForm{{$post->id}}" action="{{route('delete-post')}}"
                                          method="post">
                                        @csrf
