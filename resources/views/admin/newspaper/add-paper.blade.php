    ...
    <div class="sl-mainpanel">
        ...
        <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40">
                ...
                <form action="{{route('new-paper')}}" method="post" class="form-horizontal">
                    @csrf
                        ...
                        <div class="mg-b-25">
                            <div class=" row col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label">Newspaper Name: <span
                            ...
                            <div class=" row col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label">Newspaper Link: <span
                                            class="tx-danger">*</span></label>
